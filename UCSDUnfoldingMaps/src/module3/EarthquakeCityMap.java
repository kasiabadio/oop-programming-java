...
public class EarthquakeCityMap extends PApplet {
	...
	*/
	...
	{	
		...
		fill(0);
		textSize(16);
		text("Earthquake Key", 70, 400);
		
		fill(255, 0, 0);
		ellipse(70, 430, 17, 17);
		fill(0);
		textSize(14);
		text("5.0+ Magnitude", 90, 435);
		
		fill(255, 255, 0);
		ellipse(70, 460, 12, 12);
		fill(0);
		textSize(14);
		text("4.0+ Magnitude", 90, 465);
		
		fill(0, 0, 255);
		ellipse(70, 490, 8, 8);
		fill(0);
		textSize(14);
		text("Below 4.0", 90, 495);
